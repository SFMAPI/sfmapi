...
``app/workers/tasks/vlad_index.py`` — that requires SIFT features in
...
from app.services import dataset_service, image_bytes_service
from app.storage import similarity as sim
from app.storage import vlad as vlad_store
