...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ondelete="CASCADE", name="fk_job_project_id_project",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"], ["job.job_id"],
            ondelete="CASCADE", name="fk_task_job_id_job",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"], ["project.project_id"],
            ondelete="CASCADE", name="fk_reconstruction_project_id_project",
        ),
        sa.ForeignKeyConstraint(
            ["dataset_id"], ["dataset.dataset_id"],
            ondelete="CASCADE", name="fk_reconstruction_dataset_id_dataset",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["recon_id"], ["reconstruction.recon_id"],
            ondelete="CASCADE", name="fk_submodel_recon_id_reconstruction",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"], ["job.job_id"],
            ondelete="CASCADE", name="fk_job_event_job_id_job",
        ),
    )
