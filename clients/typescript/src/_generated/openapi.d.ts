...
export interface paths {
    ...
    "/v1/reconstructions/{recon_id}/snapshots/{seq}/dense/index.json": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Read Dense Index
         * @description Manifest of dense MVS outputs in this sealed snapshot.
         */
        get: operations["read_dense_index_v1_reconstructions__recon_id__snapshots__seq__dense_index_json_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/reconstructions/{recon_id}/snapshots/{seq}/dense/fused.bin": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Read Dense Fused
         * @description The fused dense point cloud (sfmapi binary points format).
         */
        get: operations["read_dense_fused_v1_reconstructions__recon_id__snapshots__seq__dense_fused_bin_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/reconstructions/{recon_id}/snapshots/{seq}/dense/depth_maps/{image_name}.bin": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Read Depth Map
         * @description Per-image depth map (``application/x-sfm-depth-v1``).
         */
        get: operations["read_depth_map_v1_reconstructions__recon_id__snapshots__seq__dense_depth_maps__image_name__bin_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/reconstructions/{recon_id}/snapshots/{seq}/dense/normal_maps/{image_name}.bin": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Read Normal Map
         * @description Per-image normal map (``application/x-sfm-normal-v1``).
         */
        get: operations["read_normal_map_v1_reconstructions__recon_id__snapshots__seq__dense_normal_maps__image_name__bin_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/reconstructions/{recon_id}/mesh": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Mesh
         * @description Generate a triangulated mesh from the reconstruction.
         *
         ...
         */
        post: operations["mesh_v1_reconstructions__recon_id__mesh_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/reconstructions/{recon_id}/dense": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Dense
         * @description Run dense multi-view stereo against the reconstruction.
         *
         ...
         */
        post: operations["dense_v1_reconstructions__recon_id__dense_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        FeaturesSpec: {
            ...
            sift_max_num_features?: number | null;
            /** Sift First Octave */
            sift_first_octave?: number | null;
        };
        /** GlobalSpec */
        GlobalSpec: {
            /**
        ...
        /**
         * MeshRequest
         * @description Request body for ``POST /v1/reconstructions/{rid}/mesh``.
         */
        MeshRequest: {
            /**
             * Method
        ...
        /**
         * OneShotImageInfo
         * @description Decoded image dimensions + size echoed back so consumers can
...
export interface operations {
    ...
    read_dense_index_v1_reconstructions__recon_id__snapshots__seq__dense_index_json_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    read_dense_fused_v1_reconstructions__recon_id__snapshots__seq__dense_fused_bin_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    read_depth_map_v1_reconstructions__recon_id__snapshots__seq__dense_depth_maps__image_name__bin_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    read_normal_map_v1_reconstructions__recon_id__snapshots__seq__dense_normal_maps__image_name__bin_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    mesh_v1_reconstructions__recon_id__mesh_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["MeshRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    dense_v1_reconstructions__recon_id__dense_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
